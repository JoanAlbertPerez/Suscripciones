    ...
    if ($client['estado'] == 'baja') {
      while ($i != 10) {
        ...
        switch ($i) {
          ...
          $tx_id = $xml->txId;
          $token = $xml->token;
          //$reg_sw = $this->registros_model->set_ws($tipo_token, $code_token, $msg_token, $tx_id_token, $token_token, $usuario_id, $trans_token, $msisdn, $amount, $text, $shortcode);
